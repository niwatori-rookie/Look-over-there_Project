...
<br>
プログラムの組み方を学び、機械学習でできる範囲を知るため。
<br>
<br>
機械学習における画像認識と学習させたモデルの推論。
<br>
<br>
産学連携のイベントへのアウトプット。
<br>
...
-------------------------------------------------------
[](
・未経験の状態から約1か月という短い製作期間の中で二人で製作したので、pythonやpygame、dlibの構造を知ることができたが手の認識におけるtensorflowの推論の部分は別プログラムに任せっきりになることが多く、理解することが厳しかった。
<br>\
)
<br>
